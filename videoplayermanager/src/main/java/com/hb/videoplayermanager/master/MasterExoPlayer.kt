package com.hb.videoplayermanager.master
...
import com.hb.videoplayermanager.CustomExoPlayerView
...
//        const val ID = 0x11203
    ...
    fun playWhenReady() {
        playerView?.playerEx?.playWhenReady = true
    }
    ...
    var playerView: CustomExoPlayerView? = null

    fun addPlayer(playerView: CustomExoPlayerView, autoPlay: Boolean) {
